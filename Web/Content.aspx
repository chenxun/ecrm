...
<body style="background-color: #9aadcd">
    <form id="form1" runat="server">
        <table style="width: 219px" cellpadding="0" cellspacing="0" border="0">
            <tr>
                <td align="center">
                    <asp:Label ID="Label_user" runat="server"></asp:Label><br />
                </td>
            </tr>
            <tr>
                <td align="center" valign="top">
                    <ComponentArt:NavBar ID="_NavBarContent" runat="server" Width="200px" CssClass="NavBar"
                        DefaultItemLookId="TopItemLook" DefaultItemSpacing="10" ExpandTransition="Fade"
                        ExpandDuration="200" CollapseTransition="Fade" CollapseDuration="200" ImagesBaseUrl="images/">
                        <ItemLooks>
                            <ComponentArt:ItemLook LookId="TopItemLook" CssClass="TopItem" HoverCssClass="TopItemHover" />
                            <ComponentArt:ItemLook LookId="Level2ItemLook" LabelPaddingLeft="10" CssClass="Level2Item"
                                HoverCssClass="Level2ItemHover" LeftIconWidth="16" LeftIconHeight="16" />
            ...
            <tr>
                <td align="center">
                    <br />
                    <ComponentArt:TabStrip ID="TabStrip_person" runat="server" Width="200px" MultiPageId="MultiPage_person"
                        ...
                        DefaultGroupTabSpacing="0px" ImagesBaseUrl="images/">
                        <ItemLooks>
                        ...
                        <Tabs>
                            <ComponentArt:TabStripTab Look-LeftIconVisibility="Always" Look-RightIconVisibility="Always"
                                DefaultSubGroupCssClass="TopGroup" Text="今日计划" DefaultSubGroupTabSpacing="0px"
                            ...
                            <ComponentArt:TabStripTab Look-LeftIconVisibility="Always" Look-RightIconVisibility="Always"
                                DefaultSubGroupCssClass="TopGroup" Text="即将入海" DefaultSubGroupTabSpacing="0px"
                                SubGroupCssClass="TopGroup" SelectedLook-LeftIconVisibility="Always" SelectedLook-RightIconVisibility="Always"
                                DisabledLook-LeftIconVisibility="Always" DisabledLook-RightIconVisibility="Always"
                                SubGroupTabSpacing="0px" ChildSelectedLook-LeftIconVisibility="Always" ChildSelectedLook-RightIconVisibility="Always"
                                runat="server">
                    ...
                    <ComponentArt:MultiPage ID="MultiPage_person" runat="server" Width="200px" BackColor="White"

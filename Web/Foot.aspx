...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="height: 20px">
                    <tr>
                        ...
                        <td valign="top" align="right" width="240" style="border-left: 1px solid #000000;border-right-width: 1; border-top-width: 1; border-bottom-width: 1; background-color: #D6D6DA;color: #FFFFFF">
                            
                            
                            <button name="xsubmit" class="down_tools_button" onclick="javascript: window.top.location.href = 'Logout.aspx'"><img alt="" border="0" src="images/logout.gif" align="top" />&nbsp;退出系统</button>
                        </td>
                    </tr>
                </table>
    </div>
